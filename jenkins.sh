...
runTest "tests.navigation.CheckNavigationPaths"
runTest "tests.navigation.CheckActionBarContents"
runTest "tests.navigation.CheckBackStackBetweenFrontsListsArticles"
runTest "tests.navigation.CheckBackStackInNavDrawer"
